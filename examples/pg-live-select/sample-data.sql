...
COPY assignments (id, class_id, name, value) FROM stdin (FORMAT CSV);
1,1,Homework,10
2,1,Test,100
3,2,Art Project,30
4,1,HW 2,10
...
COPY scores (id, assignment_id, student_id, score) FROM stdin (FORMAT CSV);
1,1,1,9
2,1,2,8
3,2,1,75
4,2,2,77
...
COPY students (id, name) FROM stdin (FORMAT CSV);
1,John Doe
2,Larry Loe
3,Oklahoma
\.
